...
A small React + TypeScript SPA for the telco chat demo. Lets a customer sign
in (by picking or typing a demo customer id) and chat with the assistant over
the chat-gateway's WebSocket API, with tool calls surfaced inline.
